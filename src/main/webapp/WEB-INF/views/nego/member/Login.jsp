...
<main>
    ...
    <div class="container1">
        ...
        <div class="login-buttons">
            ...
            <br>
            <button class="kakao button" onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=d9d93e271c5b4a57f5de6e5b02476dc2&redirect_uri=http://localhost:8080/mavenNego/user/kakao/callback&response_type=code'">
