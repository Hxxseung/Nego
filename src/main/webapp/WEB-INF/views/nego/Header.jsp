        ...
        <li class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <c:if test="${sessionScope.loginMethod == 'kakao'}">
                	...
                	<a href="https://kauth.kakao.com/oauth/logout?client_id=d9d93e271c5b4a57f5de6e5b02476dc2&logout_redirect_uri=http://localhost:8080/mavenNego/Logout.do">로그아웃</a>
                </c:if>
